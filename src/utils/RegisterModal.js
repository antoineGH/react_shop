...
import { Modal, Button, FormGroup, Form, InputGroup, Col, Row, NavLink, Container, Card } from 'react-bootstrap'
								...
								<Form role='form' onSubmit={handleSubmit}>
									...
									<p className='text-light' onClick={handleLogin}>
										<small style={{ color: 'rgba(83,103,125,0.75)' }} className={language === 'zh-CN' ? 'font_CN_normal' : ''}>
											...
											<span className={language === 'zh-CN' ? 'font_CN_normal' : ''} style={{ color: 'black' }}>
												{dictionary.log_in}
											</span>
										</small>
									</p>
