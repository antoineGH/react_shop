...
import { Modal, Col, Row, NavLink, Container, Card, Image } from 'react-bootstrap'
						...
						<Col md={11}>
							...
							<Row className='mb-4'>
								<Col xs={12} className='mx-auto text-center text-lg-left '>
									<span
										className={
											language === 'zh-CN' ? 'mx-auto text-center text-lg-left font_CN_normal' : 'mx-auto text-center text-lg-left'
										}>
							...
							<Row className='mb-2'>
								<Col
									...
									lg={6}
									xl={6}
									className={language === 'zh-CN' ? 'mx-auto text-center text-lg-left font_CN_normal' : 'mx-auto text-center text-lg-left'}>
							...
							<Row className='mb-4'>
								...
								<Col
									...
									xl={6}
									className={language === 'zh-CN' ? 'mx-auto text-center text-lg-left font_CN_normal' : 'mx-auto text-center text-lg-left'}>
									{dictionary.via}: {order.payment_method && titleCase(order.payment_method)}{' '}
								</Col>
							</Row>
							<Row className='mt-2'>
								{order.products &&
									order.products.map((product) => {
										return (
											<Col md={12} lg={6} key={product.product_name} className='mx-auto'>
												<Card className='mx-auto mb-3 card_cart_product text-left' key={product.product_name}>
													<Image className='product_image_quantity' style={{ width: '100%' }} src={product.image_url} />
													<p
														className={
															language === 'zh-CN'
													...
													<p
														...
														{' '}
														${formatMoney(product.unit_price)} x {product.quantity}
													</p>
													<p
														className={
															language === 'zh-CN'
														...
														style={{ marginBottom: '0.4rem' }}>
														{dictionary.total_product}: ${formatMoney(product.total_product)}
													</p>
													<p
														className={
															language === 'zh-CN'
														...
														style={{ marginBottom: '0.4rem' }}>
														{dictionary.category}: {product.category_description}
													</p>
												</Card>
											</Col>
										)
