...
import { Container, Modal, Button, Col, Row, Form, FormGroup, InputGroup, NavLink } from 'react-bootstrap'
							...
							<Row>
								<Col className='mx-auto'>
									<Form role='form' onSubmit={handleSubmit}>
										...
										<p className='text-light' onClick={handleForgot}>
										...
										<div className='text-center'>
											<Button
												...
												disabled={isDisabled}>
												{dictionary.sign_in}{' '}
												{isDisabled && <ClipLoader css='margin-bottom: -0.3%; margin-left: 1.5%' color={'white'} size={15} />}
											</Button>
										</div>
									</Form>
								</Col>
				...
				<Container>
					<Row className='justify-content-center'>
						<Col md={11} className='mt-4'>
							...
							<p className={language === 'zh-CN' ? 'modal_text_CN' : 'modal_text'}>{dictionary.benefits_personal_account}</p>
							<div className='text-center'>
								<Button
									className={
										language === 'zh-CN' ? 'mt-1 mb-4 button_cart button_modal font_CN_normal' : 'mt-1 mb-4 button_cart button_modal'
									}
									color='secondary'
									type='submit'
									disabled={isDisabled}
