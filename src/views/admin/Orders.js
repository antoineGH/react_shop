							...
							<Container className='order_vh'>
								<Row>
									<Col md={12}>
										...
										<Row>
											<Col>
												<p className='font_normal_size text-center text-md-left'>{dictionary.error_loading_orders}</p>
											</Col>
										</Row>
										<Row>
							...
							<Container className='order_vh'>
								<Row>
									<Col md={12}>
										...
										{orders.map((order) => {
											return <OrderDetails key={order.order_number} order={order} MoreInformation={MoreInformation} />
										})}
									</Col>
								</Row>
							</Container>
									...
									<Row>
										<Col>
											<p
												...
												style={{ marginBottom: '0rem', paddingTop: '2.4rem' }}>
												{dictionary.my_orders.toUpperCase()}
												<span className='product_details_count'>({dictionary.no_item})</span>
											</p>
											<p
												className={
													language === 'zh-CN'
								...
								<Col
									...
									<Row>
										<Col md={12} className='mb-md-4 '>
											<p
												className={
													language === 'zh-CN' ? 'font_normal_size_CN text-center ml-lg-5' : 'font_normal_size text-center ml-lg-5'
												}
												style={{ marginBottom: '0rem', paddingTop: '1.4rem' }}>
												<FontAwesomeIcon className='mr-1' size='1x' icon={['fas', 'mobile-alt']} />
												{'    '}
									...
									<Row style={{ borderBottom: '#eae8e4 1px solid' }}>
										...
										<Col xs={10} sm={10} md={10} lg={10} className='my-auto' style={{ marginBottom: '1rem' }}>
											<p
												className={language === 'zh-CN' ? 'font_normal_size_CN ml-5' : 'font_normal_size ml-5'}
												style={{ fontSize: '1.1rem', marginBottom: '0rem', padding: '1rem' }}>
												{dictionary.packaging}
											</p>
										</Col>
