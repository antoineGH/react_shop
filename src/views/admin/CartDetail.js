...
export default function CartDetail(props) {
  ...
  const makeLink = (product) => {
    return encodeURIComponent(
      product.product_id +
        "_" +
        product.product_name.toLowerCase().trim().replaceAll(" ", "_")
    );
  };
        ...
        <Row className="no-gutters">
          <Col md={3} className="my-auto">
            <Link to={"/product/" + makeLink(cartdetail)}>
              <Image
                className="card_product_image_quantity"
            ...
            <Card.Body>
              <Row className="justify-content-center">
                <Col style={{ marginBottom: "0" }}>
                  <Link
                    to={"/product/" + makeLink(cartdetail)}
                    style={{ color: "black" }}
                  >
                    <Card.Text
              ...
              <Row>
                <Col style={{ marginTop: "0", marginBottom: "0" }}>
                  <Card.Text
                    className={
                      language === "zh-CN"
                        ? "font_CN_normal text-center text-md-left"
          ...
          <Col md={2} className="my-auto">
            <Row className="text-center justify-content-center text-md-right mt-2 mb-2 mb-lg-0 mt-lg-0">
              ...
              <Col
                ...
                lg={2}
                xl={2}
                className="quantity_modal_count my-auto ml-1 mr-2"
              >
