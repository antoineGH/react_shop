  ...
  function handleDelete(cart_id) {
    deleteCart(cart_id)
      .then((response) => {
        ...
        const toDelete = cart.filter(
          (CartCopyDelete) => CartCopyDelete.cart_id === cart_id
        );
        ...
        cartCopy = cartCopy.filter(
          (cartCopyDetails) => cartCopyDetails.cart_id !== cart_id
        );
                ...
                <Col md={12}>
                  ...
                  <Row>
                    <Col>
                      ...
                      >
                        {"My Shopping Bag".toUpperCase()}{" "}
                        <span className="product_details_count">(Empty)</span>
                      </p>
                    </Col>
                  </Row>
                </Col>
