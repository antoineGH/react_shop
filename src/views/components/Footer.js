      ...
      <Row className="justify-content-center row_footer">
        <Col md={11}>
          <Row className="logo_font_footer ml-sm-0 text-center text-sm-left">
            <Col>{"Luxury Shop".toUpperCase()}</Col>
          </Row>
        </Col>
      </Row>
      <Row
        className="justify-content-center text-center text-md-left"
        style={{ marginRight: "0" }}
      >
        <Col md={11}>
          <Row>
            ...
            <Col md={3}>
              <p
                className={
                  language === "zh-CN" ? "font_footer_CN" : "font_footer"
                }
              >
