    ...
    return (
      <Container fluid>
            ...
            <Row>
              ...
              >
                <NavLink
                  className={
                    language === "zh-CN"
                      ? "text-center filter_menu_CN font_CN_normal my-auto "
                      : "text-center filter_menu my-auto"
                  }
                >
                  {dictionary.filter}
                  <FontAwesomeIcon
        ...
        <Container>
          <Row>
            <Col>
              <p className="font_normal_size text-center">
                {dictionary.error_loading_products}
              </p>
            </Col>
          </Row>
          <Row>
